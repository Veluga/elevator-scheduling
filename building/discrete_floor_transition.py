...
class DiscreteFloorTransition(Building):
    ...
    def __init__(self, *args, track_passengers=False, **kwargs):
        super().__init__(*args, **kwargs)
        self.reset()
        self._total_reward = 0
        self.track_passengers = track_passengers

    def call(self, call_floor, destination_floor):
        """Store information about call generated by caller."""
        passenger = Passenger()
        if self.track_passengers:
    ...
    def perform_action(self, actions):
        ...
        # Increase waiting/system time of passengers in system
        if self.track_passengers:
        ...
        for elevator, action in zip(self.elevators, actions):
            ...
            if elevator.cur_floor in elevator.buttons_pressed:
                self._total_reward += s.REWARD_DELIVERED_PASSENGER
