...
PPO_NUM_PARALLEL_ENVIRONMENTS = 1
PPO_REPLAY_BUFFER_CAPACITY = REPLAY_BUFFER_MAX_LENGTH // PPO_NUM_PARALLEL_ENVIRONMENTS
PPO_COLLECT_EPISODES_PER_ITERATION = 7
PPO_EVAL_INTERVAL = 500
PPO_NUM_EVAL_EPISODES = 3
PPO_LOG_INTERVAL = 1
PPO_TRAIN_CHECKPOINT_INTERVAL = 1
PPO_POLICY_CHECKPOINT_INTERVAL = 1
